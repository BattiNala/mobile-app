...
class DetectionKeywords {
  ...
  static const Map<String, List<KeywordEntry>> electrical = {
    ...
    'Wire': [
      ...
      KeywordEntry('electricity', priority: 10, exactMatch: true),
      KeywordEntry('electrical', priority: 10, exactMatch: true),
      KeywordEntry('power', priority: 8),
  ...
  static const Map<String, List<KeywordEntry>> sewage = {
    'Manhole': [
      ...
      KeywordEntry('sewage', priority: 10, exactMatch: true),
      KeywordEntry('sewer', priority: 10, exactMatch: true),
      KeywordEntry('drain', priority: 9, exactMatch: true),
      KeywordEntry('drainage', priority: 9),
  ...
  static const Map<String, List<KeywordEntry>> priority = {
    ...
    'NORMAL': [
      ...
      KeywordEntry('overflow', priority: 7),
      KeywordEntry('overflowing', priority: 7),
      KeywordEntry('waterlogging', priority: 7),
      KeywordEntry('sewage', priority: 6),
      KeywordEntry('drain', priority: 6),
